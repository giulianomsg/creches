...
ALTER TABLE students
    ...
    ADD COLUMN IF NOT EXISTS cpf_aluno VARCHAR(14) NULL,
    ADD COLUMN IF NOT EXISTS email_contato VARCHAR(150) NULL,
...
ALTER TABLE students
    ...
    MODIFY COLUMN cpf_aluno VARCHAR(14) NULL,
    MODIFY COLUMN email_contato VARCHAR(150) NULL,
